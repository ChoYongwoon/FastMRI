...
def parse():
    ...
    parser.add_argument('-p', '--path_data', nargs = '+', type=Path, default=['C:\FastMRI/Data/leaderboard/', 'C:\Fastmri/Data/leaderboard/reconstructions_leaderboard/'], help='Directory of test data')
    parser.add_argument('--in-chans', type=int, default=1, help='Size of input channels for network')
    parser.add_argument('--out-chans', type=int, default=1, help='Size of output channels for network')
    parser.add_argument("--input_key", type=str, nargs = '+',default=['image_input', 'image_grappa'], help='Name of input key')
