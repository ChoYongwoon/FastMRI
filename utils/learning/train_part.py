...
from utils.common.augment import Augmenter


def train_epoch(args, epoch, model, data_loader, optimizer, loss_type, device, augmenter):
    model.train()
...
def train(args):
    ...
    train_loader = create_data_loaders(data_path = args.data_path_train, args = args, shuffle=True, train = False)
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        train_loss, train_time = train_epoch(args, epoch, model, train_loader, optimizer, loss_type, device, augmenter)
